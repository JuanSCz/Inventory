            ...
            data.detallesCompra.forEach((detalle, index) => {
                ...
                newRow.innerHTML = `
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control form-control-detalle" name="detallesCompra[${index}].cantidad" id="cantidad${index}" placeholder="Ingrese la cantidad..." required>
                    </div>
                    <div class="col-md-4 mb-3">
